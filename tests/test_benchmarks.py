...
def test_uuid1_stdlib(benchmark) -> None:
    benchmark(lambda: uuid.uuid1(node))


@pytest.mark.benchmark
def test_uuid1_utils(benchmark) -> None:
    benchmark(lambda: uuid_utils.uuid1(node))


@pytest.mark.benchmark
def test_uuid3_stdlib(benchmark) -> None:
    benchmark(lambda: uuid.uuid3(namespace=uuid.NAMESPACE_DNS, name="python.org"))


@pytest.mark.benchmark
def test_uuid3_utils(benchmark) -> None:
    benchmark(
...
@pytest.mark.benchmark
def test_uuid4_stdlib(benchmark) -> None:
    benchmark(lambda: uuid.uuid4())


@pytest.mark.benchmark
def test_uuid4_utils(benchmark) -> None:
    benchmark(lambda: uuid_utils.uuid4())


@pytest.mark.benchmark
def test_uuid5_stdlib(benchmark) -> None:
    benchmark(lambda: uuid.uuid5(namespace=uuid.NAMESPACE_DNS, name="python.org"))


@pytest.mark.benchmark
def test_uuid5_utils(benchmark) -> None:
    benchmark(
